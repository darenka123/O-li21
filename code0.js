...
gdjs.MenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8966092);
}
}}
}
...
gdjs.MenuCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8969476);
}
}}
if (gdjs.MenuCode.condition1IsTrue_0.val) {
